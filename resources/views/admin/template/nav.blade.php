                            ...
                            @foreach ($subsections as $sub)
                                @if ($seccion->id == $sub->padre_id)
                                    <li class="nav-item" data-toggle="tooltip" data-placement="right">
                                        <a class="nav-link nav-link-collapse collapsed aSidebar" data-toggle="collapse" data-target="#multi_menu_sub{{$sub->subsection}}">
        ...
        <div id="app">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    ...
                    <a id="navbarDropdown" class="nav-link dropdown-toggle link_login" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        {{ Auth::user()->name }}
                    </a>

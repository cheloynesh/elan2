...
Route::post('admin/pruebas/prueba/importPoliz/{active}','PruebasController@importPoliz');
...
Route::get('policies/viewPolicies/GetInfoRcp/{id}','ViewPoliciesController@GetInfoRcp')->name('viewPolicies.GetInfoRcp');
...
Route::post('policies/viewPolicies/saveRcp', 'ViewPoliciesController@saveRcp')->name('viewPolicies.saveRcp');
Route::post('policies/viewPolicies/deleteRcp', 'ViewPoliciesController@deleteRcp')->name('viewPolicies.deleteRcp');
...
Route::post('policies/viewPolicies/ExportPolicies','ViewPoliciesController@ExportPolicies');
Route::post('policies/viewPolicies/ExportReceiptsVP','ViewPoliciesController@ExportReceiptsVP');
